...
def fetch_wiki_image(title, filename):
    url = f"https://en.wikipedia.org/w/api.php?action=query&prop=imageinfo&iiprop=url&titles=File:{title}&format=json"
...
images = [
    ("Denim_jacket.jpg", "w_jacket.jpg"),
    ("Blue_jeans.jpg", "w_jeans.jpg"),
]

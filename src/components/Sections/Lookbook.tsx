...
export function Lookbook() {
  return (
    <section id="lookbook" className="w-full bg-[#111111] text-white py-32 px-6 md:px-12 relative">
      <div className="flex flex-col items-center mb-32 text-center max-w-4xl mx-auto">
        <span className="font-sans text-accent tracking-widest uppercase text-sm mb-4 block">Visual Archive</span>
        <TextReveal className="font-serif text-5xl md:text-7xl uppercase tracking-tighter mb-6 text-white">
          EDITORIAL LOOKBOOK
        </TextReveal>
      </div>
      ...
      <div className="flex flex-col gap-32 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24">
          <motion.div 
            className="w-full md:w-[60%] h-[70vh]"
          ...
          >
            <span className="font-sans text-accent tracking-widest text-sm mb-4">LOOK 01</span>
            <h3 className="font-serif text-4xl md:text-5xl mb-6 text-white">THE TRUCKER</h3>
            <p className="font-sans text-white/60 font-light leading-relaxed max-w-sm">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-24">
          ...
          <motion.div 
            ...
            transition={{ duration: 1, delay: 0.2 }}
          >
            <span className="font-sans text-accent tracking-widest text-sm mb-4">LOOK 02</span>
            <h3 className="font-serif text-4xl md:text-5xl mb-6 text-white">THE OVERALLS</h3>
            <p className="font-sans text-white/60 font-light leading-relaxed max-w-sm">

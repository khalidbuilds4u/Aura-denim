...
images = [
    ("Feel_The_Wind_(Unsplash).jpg", "modest_jacket.jpg"),
    ("Denim_shirt_and_leggings.jpg", "modest_shirt.jpg"),
    ("Young_woman_in_marinière,_denim_jacket_en_wrap_skirt.jpg", "modest_skirt.jpg"),
    ("Woman_in_ripped_jeans_(Unsplash).jpg", "modest_jeans.jpg"),
    ("Denim_Jacket,_Colorful_Abstract_Print_Dress,_Red_Pixie_Cut.jpg", "modest_dress.jpg")
]

for t, f in images:
    fetch_wiki_image(t, f)
